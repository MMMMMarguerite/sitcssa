      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <form class="form-signin" role="form">
                ...
                <button class="btn btn-lg btn-primary btn-block" data-loading-text="正在验证..." type="submit">登陆</button>
              </form>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <form class="form-signin" role="form">
                ...
                <div class="row">
                  <div class="col-md-7">
                    <input name="email" type="text" class="form-control" placeholder="史蒂文斯用户名" required autofocus>
                  </div>
                  <div class="col-md-5">
                    <h5> @stevens.edu </h5>
                  </div>
